      ...
      <main className="pt-24 pb-20 bg-white min-h-screen">
        ...
        <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-16 overflow-visible">
            ...
            <div className="md:w-1/2 relative group perspective-1000">
               ...
               {/* Image Container */}
               <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] border-8 border-white transform transition-all duration-700 hover:rotate-1 hover:scale-[1.01] bg-secondary-dark aspect-[3/2]">
