        ...
        <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-16 overflow-visible">
            ...
            <div className="md:w-1/2 relative group perspective-1000">
               ...
               <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] border-8 border-white transform transition-all duration-700 hover:rotate-1 hover:scale-[1.01]">
                 ...
                 <div className="absolute inset-0 bg-gradient-to-t from-secondary-dark/90 via-secondary-dark/20 to-transparent opacity-80 group-hover:opacity-60 transition-opacity duration-500"></div>
               ...
               {/* Floating Badge */}
               <div className="absolute -top-4 -right-4 z-20 bg-secondary-dark text-white w-28 h-28 rounded-full flex flex-col items-center justify-center font-bold text-center shadow-xl border-4 border-white animate-float">
